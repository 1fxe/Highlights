package dev.fxe.sample;

import dev.fxe.highlights.Highlight;
import dev.fxe.highlights.Highlights;
import dev.fxe.highlights.LocalizedPair;
import dev.fxe.highlights.NVGSDK_HighlightSignificance;
import dev.fxe.highlights.NVGSDK_HighlightType;
import org.lwjgl.*;
...
public class Main {
    ...
    private void init() {
        ...
        // Create the window
        window = glfwCreateWindow(300, 300, "LWJGL Demo", NULL, NULL);
        if (window == NULL)
